...
val=input("Irj be egy szövet: ")
list1=list(val)
print(list1)
print(" a els es utolso eleme %s és a %s" %(list1[0],list1[-1]))
print(" a els es utolso eleme %s és a %s" %(list1[0],list1[-1]))
print("a kusta %s eleme van" %len(list1))
print("lista elemei sz9vegként %s" %"".join(list1))
print("szokozonkent menten feldarabolva: %s" %val.split(" "))
